...
<!DOCTYPE html><html>
    ...
    <body>
        ...
        <div id="data-content">
            ...
            <div id="table-part">
                <h2 class="table-text">Parents / Guardians</h2>
                <table id="table">
                    <tr>
                        <th>Parent ID</th>
                        <th>Name</th>
                        ...
                        if($conn-> connect_error) {
                            ...
                            if($result-> num_rows > 0) {
                                while ($row = $result-> fetch_assoc()){
                                    echo "<tr><td>". $row["parent_ID"] ."</td><td>". $row["parent_name"] ."</td><td>". $row["parent_surname"] ."</td><td>". $row["parent_address"] ."</td><td>". $row["parent_phone"] ."</td><td>". $row["parent_email"] ."</td><td>". $row["parent_gender"] ."</td><td>". $row["parent_bdate"] ."</td><td>". $row["pupil_ID"] ."</td></tr>";
                                }
                                echo "</table>";
                            }
                            else {
