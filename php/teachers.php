...
<!DOCTYPE html><html>
    ...
    <body>
        ...
        <div id="data-content">
            ...
            <div id="table-part">
                <h2 class="table-text">Teachers</h2>
                <table id="table">
                    <tr>
                        <th>Teacher ID</th>
                        <th>Name</th>
                        ...
                        if($conn-> connect_error) {
                            ...
                            if($result-> num_rows > 0) {
                                while ($row = $result-> fetch_assoc()){
                                    echo "<tr><td>". $row["teacher_ID"] ."</td><td>". $row["teacher_name"] ."</td><td>". $row["teacher_surname"] ."</td><td>". $row["teacher_bdate"] ."</td><td>". $row["teacher_phone"] ."</td><td>". $row["teacher_address"] ."</td><td>". $row["teacher_gender"] ."</td><td>". $row["teacher_qualification"] ."</td><td>". $row["teacher_email"] ."</td><td>". $row["class_ID"] ."</td></tr>";
                                }
                                echo "</table>";
                            }
                            else {
