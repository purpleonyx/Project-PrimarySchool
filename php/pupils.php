                        ...
                        if($conn-> connect_error) {
                            ...
                            if($result-> num_rows > 0) {
                                while ($row = $result-> fetch_assoc()){
                                    echo "<tr><td>". $row["pupil_ID"] ."</td><td>". $row["pupil_name"] ."</td><td>". $row["pupil_surname"] ."</td><td>". $row["pupil_phone"] ."</td><td>". $row["pupil_address"] ."</td><td>". $row["pupil_gender"] ."</td><td>". $row["pupil_bdate"] ."</td><td>". $row["pupil_email"] ."</td><td>". $row["parent_ID"] ."</td><td>". $row["class_ID"] ."</td></tr>";
                                }
                                echo "</table>";
                            }
                            else {
